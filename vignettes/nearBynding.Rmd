...
knitr::include_graphics("all_contexts.jpeg")
knitr::include_graphics("all_contexts.pdf")
```
...
```{r, fig.show='hold', echo = F, out.width = '50%'}
knitr::include_graphics("stem_only.jpeg")
knitr::include_graphics("stem_only.pdf")
```
