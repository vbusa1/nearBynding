...
processCapRout <- function(CapR_outfile,
  ...
  export.bedGraph(GRanges_bulge, paste0(
    output_prefix,
    "_bulge.bedGraph"
  ))
  liftOverToExomicBG(
  ...
  export.bedGraph(GRanges_exterior, paste0(
    output_prefix,
    "_exterior.bedGraph"
  ))
  liftOverToExomicBG(
  ...
  export.bedGraph(GRanges_hairpin, paste0(
    output_prefix,
    "_hairpin.bedGraph"
  ))
  liftOverToExomicBG(
  ...
  export.bedGraph(GRanges_internal, paste0(
    output_prefix,
    "_internal.bedGraph"
  ))
  liftOverToExomicBG(
  ...
  export.bedGraph(GRanges_multibranch, paste0(
    output_prefix,
  ...
  export.bedGraph(GRanges_stem, paste0(
    output_prefix,
    "_stem.bedGraph"
  ))
  liftOverToExomicBG(
